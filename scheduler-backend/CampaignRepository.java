...
public interface CampaignRepository extends JpaRepository<CampaignMapping, String> {
        ...
        /**
         * Reset weekly frequency for campaigns to their original values
         * Used by the scheduler to reset frequencies at the start of each week
         * 
         * @param campaignIds List of campaign IDs to reset
        ...
        @Query(value = "UPDATE [dbo].[campaigns_dev_rotation1] SET "
                        ...
                        + "AND original_frequency_per_week IS NOT NULL", nativeQuery = true)
